...
func (_mock *MockFileWriter) WriteFile(path string, data []byte, perm os.FileMode) error {
...
//   - data []byte
//   - perm os.FileMode
func (_e *MockFileWriter_Expecter) WriteFile(path interface{}, data interface{}, perm interface{}) *MockFileWriter_WriteFile_Call {
	return &MockFileWriter_WriteFile_Call{Call: _e.mock.On("WriteFile", path, data, perm)}
}

func (_c *MockFileWriter_WriteFile_Call) Run(run func(path string, data []byte, perm os.FileMode)) *MockFileWriter_WriteFile_Call {
...
func (_c *MockFileWriter_WriteFile_Call) RunAndReturn(run func(path string, data []byte, perm os.FileMode) error) *MockFileWriter_WriteFile_Call {
	_c.Call.Return(run)
	return _c
}
